...
ctaMensaje: Hola vengo desde la web y quiero cotizar contabilidad mensual
faqs:
  - q: ¿Es más barato llevar la contabilidad por mi cuenta?
    a: Al principio parece que sí, porque no pagas honorarios. Pero el tiempo que le dedicas y el riesgo de equivocarte en una declaración suelen costar más que el servicio. La mayoría de los emprendedores que lo intentan terminan buscando ayuda cuando aparece el primer problema.
  - q: ¿El precio sube si tengo más de una empresa?
    a: Sí, porque cada empresa tiene sus propias obligaciones y declaraciones. Se cotiza por separado, aunque si son del mismo dueño se puede ordenar todo en conjunto.
...
Mucha gente busca al contador como busca el pan, mirando solo el número de abajo. El problema es que con la contabilidad ese número de abajo esconde realidades muy distintas. Hay quien cobra muy poco y a cambio solo presenta los formularios obligatorios, sin mirar tu negocio ni responderte una duda en todo el mes. Y hay quien cobra un poco más porque está mirando tu situación, te avisa antes de que algo se transforme en multa y te contesta cuando lo necesitas.

Las dos cosas se llaman contador, pero no son el mismo servicio. Por eso comparar solo por precio te puede salir caro más adelante.

## Qué hace mover el precio

Hay cuatro cosas que explican casi siempre la diferencia entre una cotización y otra.

La primera es tu nivel de ventas. A mayor facturación, más documentos, más movimiento y más cuidado requiere tu contabilidad cada mes. Es el factor que más pesa.

La segunda es tu tipo de empresa y tu régimen tributario. No es lo mismo una persona con inicio de actividades de segunda categoría que una SpA acogida a un régimen general. Cada estructura tiene sus obligaciones, y algunas dan bastante más trabajo que otras.

La tercera es si tienes trabajadores. En el momento en que contratas a alguien aparecen liquidaciones de sueldo, cotizaciones, finiquitos y cumplimiento laboral. Eso es contabilidad de remuneraciones, y suma al trabajo mensual.

La cuarta es qué tan ordenado llega tu mes. Una empresa que entrega sus documentos a tiempo y con todo claro toma menos horas que una que llega con seis meses atrasados y papeles sueltos. Poner las cosas al día tiene un costo, aunque después el mes corriente se estabiliza.
